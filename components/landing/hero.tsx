  ...
  return(
    <section className="flex flex-col items-center">
        <div>
            ...
            <span className="flex justify-center gap-2 mt-4"><Button asChild className="cursor-pointer"><Link href="/dashbord">See pros & cons</Link></Button><Button asChild className="cursor-pointer" variant="secondary"><Link href="/how-it-works">How it works</Link></Button></span>
