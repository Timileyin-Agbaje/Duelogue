  ...
  return(
    <section className="flex flex-col items-center">
        <div>
            ...
            <span className="flex justify-center gap-2 mt-4"><Button className="cursor-pointer">See pros & cons</Button><Button className="cursor-pointer" variant="secondary">Browse Examples</Button></span>
