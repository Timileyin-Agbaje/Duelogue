  ...
  return(
    <section className="flex flex-col items-center">
        <div>
            ...
            <span className="flex justify-center gap-2 mt-4"><Button asChild className="cursor-pointer"><a href="#features">See pros & cons</a></Button><Button asChild className="cursor-pointer" variant="secondary"><a href="#how-it-works">How it works</a></Button></span>
